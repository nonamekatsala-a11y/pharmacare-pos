...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-40 h-screen w-80 border-r border-primary-600 bg-primary-500 text-white transition-transform duration-300 md:hidden flex flex-col ${
